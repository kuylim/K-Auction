				...
				<table class="table table-condensed">
					<thead>
						<tr class="cart_menu" style=" ">
							<td class="image">ផលិតផល</td>
							<td class="description"></td>
							<td class="price">តំលៃ</td>
							<td class="quantity">ចំនួន Bid</td>
					...
					<tbody>
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									<input class="cart_quantity_input" type="text" disabled="" name="quantity" value="6" autocomplete="on" size="2">
								</div>
							</td>
							<td class="cart_total">
								<p class="cart_total_price">$210</p>
							</td>
						...
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									<input class="cart_quantity_input" type="text" name="quantity" disabled="" value="10" autocomplete="off" size="2">
								</div>
							</td>
							<td class="cart_total">
								<p class="cart_total_price">$390</p>
							</td>
							<td class="cart_delete">
								<a class="cart_quantity_delete" href=""><i class="fa fa-times"></i></a>
							</td>
						...
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									<input class="cart_quantity_input" type="text" name="quantity" disabled="" value="8" autocomplete="off" size="2">
								</div>
							</td>
							<td class="cart_total">
								<p class="cart_total_price">$16</p>
							</td>
							<td class="cart_delete">
								<a class="cart_quantity_delete" href=""><i class="fa fa-times"></i></a>
							</td>
			...
			<div class="row">
				...
				<div class="col-sm-12 padding-right">
					...
					<div class="recommended_items"><!--recommended_items-->
						<h2 class="title text-center" style="padding-top: 5px;">ផលិតផលដែលអ្នកអាចនឹងចូលចិត្ដ</h2>
						...
						<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
							 ...
							 <a class="left recommended-item-control" href="#recommended-item-carousel" data-slide="prev">
							  ...
							  <a class="right recommended-item-control" href="#recommended-item-carousel" data-slide="next" style="background:">
