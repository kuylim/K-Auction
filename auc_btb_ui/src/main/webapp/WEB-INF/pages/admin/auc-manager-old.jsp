        ...
        <div class="right_col" role="main">
          ...
          ​​   
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <a href="${pageContext.request.contextPath }/add" class="btn btn-success pull-right">Add Product</a>
                <div class="x_panel">
                  <div class="x_content">
                   
                  
                     <div class="table-responsive">   
                      <table class="table table-striped jambo_table bulk_action" id="datatable-fixed-header">
                      
                        <thead>
                          <tr class="headings">
                            <th class="column-title">ឈ្មោះ </th>
                            <th class="column-title">លេខទូរស័ព្ទ </th>
                            <th class="column-title">ចំនួនទឹកប្រាក់ </th>
                            <th class="column-title">ចំនួន Bids </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            <td class=" ">នីសា </td>
                            <td class=" ">089789765 </td>
                            <td class=" ">1800 Credit </td>
                            <td class=" ">10 </td>
                            <td class=" ">Active </td>
                          ...
                          <tr class="odd pointer">
                            <td class=" ">សៀវម៉ី </td>
                            <td class=" ">078906780 </td>
                            <td class=" ">2000 Credit </td>
                            <td class=" ">10 </td>
                            <td class=" ">Active </td>
                            <td class=" last"><a href="#">View</a>
                            </td>
